...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C928%20rows-8250df">
...
**Public extract:** 7,928 rows · **Live catalog:** 7,926 domains
...
- `run.csv` — public CSV extract (7,928 rows)
- `run.json` — public JSON extract (7,928 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,928-row public sample | 7,926 live domains                               |
