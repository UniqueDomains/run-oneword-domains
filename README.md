# Available .RUN One-Word Domains (26,002)
...
**Public extract:** 1,000 rows · **Live catalog:** 26,002 domains · **Median ask:** $5.25 · **High-demand under $2,500:** 1
...
| --------- | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------------------------- |
| track.run | resell    | —         | —             | high           | medium | 5      | Go Australia Domains, LLC                    |
...
> Unique Domains. *Available .RUN One-Word Domains*. Version 2026-09-20. Public GitHub extract for the exact Unique Domains search represented by this repository.
