# Available .RUN One-Word Domains (26,887)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-26%2C887%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **26,887 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 26,887 domains · **Median ask:** $5.30 · **High-demand under $2,500:** 1
...
| nail.run        | resell    | $6.99     | $41.99        | low            | low    | 4      | name.com                       |
| abo.run         | premium   | $13       | $26           | low            | low    | 3      | namecheap                      |
| area.run        | available | $6.99     | —             | high           | low    | 4      | name.com                       |
| crimson.run     | resell    | $6.99     | —             | medium         | low    | 7      | name.com                       |
...
| van.run         | resell    | —         | —             | medium         | low    | 3      | Spaceship, Inc.                |
| hat.run         | premium   | $23.60    | $23.60        | low            | low    | 3      | namesilo                       |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 26,887 live domains                        |
...
> Unique Domains. *Available .RUN One-Word Domains*. Version 2026-09-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
