...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C913%20rows-8250df">
...
> **Important:** this repository is a **public 7,913-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,983 domains** on the canonical page below.

**Public extract:** 7,913 rows · **Live catalog:** 5,621,983 domains
...
- `run.csv` — public CSV extract (7,913 rows)
- `run.json` — public JSON extract (7,913 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,913-row public sample | 5,621,983 live domains                           |
...
> Unique Domains. *Available .RUN One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
