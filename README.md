# Available .RUN One-Word Domains (5,621,983)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C909%20rows-8250df">
...
> **Important:** this repository is a **public 7,909-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,983 domains** on the canonical page below.

**Public extract:** 7,909 rows · **Live catalog:** 5,621,983 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/run?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/run?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./run.csv">CSV</a> / <a href="./run.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .RUN search](https://unique.domains/domains/tld/run?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .RUN search](https://unique.domains/domains/tld/run?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_run_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./run.csv) or [Download JSON](./run.json)
...
- `run.csv` — public CSV extract (7,909 rows)
- `run.json` — public JSON extract (7,909 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,909-row public sample | 5,621,983 live domains                           |
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------------------------------------------------------------ |
| yard.run      | available | $6.99     | $41.99        | 80             | 34     | 4      | name.com                                                           |
...
| trinity.run   | available | $6.99     | $41.99        | 72             | 31     | 7      | name.com                                                           |
| wise.run      | resell    | —         | —             | 98             | 72     | 4      | DNSPod, Inc.                                                       |
| allegro.run   | premium   | $6.99     | $41.99        | 100            | 24     | 7      | name.com                                                           |
...
| extra.run     | available | $6.99     | $41.99        | 102            | 28     | 5      | name.com                                                           |
| flow.run      | resell    | —         | —             | 96             | 67     | 4      | Alibaba Cloud Computing Ltd. d/b/a HiChina (www.net.cn)            |
| cup.run       | premium   | $13       | $26           | 76             | 23     | 3      | namecheap                                                          |
| three.run     | available | $6.99     | $41.99        | 88             | 28     | 5      | name.com                                                           |
| open.run      | resell    | —         | —             | 106            | 61     | 4      | Domain Science Kutatási Szolgáltató Korlátolt Felelősségű Társaság |
| political.run | premium   | $26       | $26           | 80             | 21     | 9      | namecheap                                                          |
| adept.run     | available | $6.99     | $41.99        | 92             | 27     | 5      | name.com                                                           |
...
> Unique Domains. *Available .RUN One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
