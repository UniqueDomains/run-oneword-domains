# Available .RUN One-Word Domains (7,917)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C925%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-7%2C917%20domains-6f42c1">
...
**Public extract:** 7,925 rows · **Live catalog:** 7,917 domains
...
- `run.csv` — public CSV extract (7,925 rows)
- `run.json` — public JSON extract (7,925 rows)
...
| adept.run     | available | $6.99     | $41.99        | 92             | 26     | 5      | name.com                                                |
...
| ----------------------- | ------------------------------------------------ |
| 7,925-row public sample | 7,917 live domains                               |
...
> Unique Domains. *Available .RUN One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
